...
const Clients = () => {
  return (
    <div className="grid w-[90%] mx-auto grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 bg-dark-gradient p-10 sm:p-12 md:p-14  rounded-2xl whitespace-nowrap">
      <div className="bg-[var(--accent)]/30 shadow-2xl hover:-translate-y-2 transition-all cursor-pointer p-8 rounded-2xl flex flex-col gap-4 items-center ">
